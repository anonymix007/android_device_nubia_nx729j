...
TARGET_RECOVERY_DEVICE_MODULES := libinit_nx729j
...
BOARD_SUPER_PARTITION_SIZE := 10737418240 #0x280000000
BOARD_SUPER_PARTITION_GROUPS := qti_dynamic_partitions
#BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_dlkm system_ext vendor vendor_dlkm
BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_dlkm system_ext vendor vendor_dlkm
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 10733223936 #0x27fc00000
...
# Sensors
#SOONG_CONFIG_NAMESPACES += SENSORS_NUBIA
#SOONG_CONFIG_SENSORS_NUBIA += USES_SINGLE_TAP_SENSOR
#SOONG_CONFIG_SENSORS_NUBIA_USES_SINGLE_TAP_SENSOR := true
#SOONG_CONFIG_SENSORS_NUBIA += USES_UDFPS_SENSOR
#SOONG_CONFIG_SENSORS_NUBIA_USES_UDFPS_SENSOR := true
...
# Vibrator
#SOONG_CONFIG_NAMESPACES += NUBIA_VIBRATOR
#SOONG_CONFIG_NUBIA_VIBRATOR := USE_EFFECT_STREAM
#SOONG_CONFIG_NUBIA_VIBRATOR_USE_EFFECT_STREAM := true
